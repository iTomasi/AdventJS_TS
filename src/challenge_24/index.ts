...
import { checkIsSameTree } from "./function";
...
const exampleData = [
    ...
    {
        value: 1,
        left: { value: 5, left: { value: 2, left: null, right: null }, right: null },
        right: { value: 6, left: null, right: { value: 4, left: null, right: null } }
    }
]

const response = checkIsSameTree(exampleData[0], exampleData[1]);
